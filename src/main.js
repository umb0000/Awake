...
const Main = () => {
  ...
  return (
    <div className="relative w-[100%] h-[800px] custom-gradient overflow-hidden">
     ...
     {/* 말풍선 */}
      <div className="absolute top-12 left-4 bg-white text-white px-1 py-1 rounded-lg shadow-lg max-w-[100px] h-[30px] flex items-center justify-center text-center  break-all whitespace-pre-line z-10">
