    ...
    <div className="relative w-full h-[800px] flex items-start justify-center">
      <div className="w-full max-w-[400px] h-auto flex flex-col items-center justify-start">
        ...
        <div className="flex flex-col items-center justify-start  w-[100%] h-auto">
          ...
          {/* 수정된 버튼 스타일 */}
          <div style={{ backgroundColor: '#c0e4dc', marginTop : '10%', width : '50%', height : 'auto'}}className="w-[80%] h-auto flex items-center justify-center rounded-[15px] ">
            <div style={{fontSize: '4vw', padding: '3% 0'}}className="self-stretch text-center text-[4vw] leading-[5vw] tracking-[.01em] font-['Pretendard_Variable'] font-medium text-[#000] ">
              버리러 가기
            </div>
          </div>
        </div>
