  ...
  return (
    <div className="fixed w-[100%] h-[800px] bg-[#fff] overflow-hidden">
      ...
      <div className="fixed left-0 top-[0px] w-[100%] h-[64px] flex flex-row items-center justify-start gap-[4px] py-[8px] px-[4px] bg-[#fff] shadow-md">
        ...
        <div className="flex-1 text-[18px] leading-[28px] font-bold text-[#1d1b20] text-center">할 일 추가</div>
      ...
      <div className="absolute left-0 top-[80px] w-[100%] flex flex-col items-center gap-[19px] py-[10px] px-0">
        <div className="relative w-[95%] h-[72px]">
          <div className="absolute left-0 top-0 w-[71px] text-[14px] font-bold text-[#49454f]">할 일 이름</div>
          <input
            type="text"
            value={taskName}
        ...
        <div className="relative w-[95%] h-[72px] flex flex-col items-start gap-[5px]">
          <div className="text-[14px] font-bold text-[#49454f]">중요도, 긴급도</div>
          <div className="flex flex-row gap-[5px]">
            <button
              onClick={() => setPriority(!priority)} // 클릭하면 상태 토글
              className={`w-[163px] h-[40px] rounded-[2px] p-[8px] ${priority ? 'bg-[#ff9800]' : 'bg-[#fff]'} border border-[#f7f7f7]`}
            >
              중요
            </button>
            <button
              onClick={() => setUrgency(!urgency)} // 클릭하면 상태 토글
              className={`w-[163px] h-[40px] rounded-[2px] p-[8px] ${urgency ? 'bg-[#ff9800]' : 'bg-[#fff]'} border border-[#f2f2f2]`}
            >
              긴급
            </button>
          </div>
        ...
        <div className="relative w-[95%] h-[144px] flex flex-col gap-[8px]">
          ...
          <div className="flex flex-row justify-between bg-[#fff] border-b border-[#f2f2f2] py-[8px]">
            <div className="text-[12px] text-[#49454f]">마감일</div>
        ...
        <div className="relative w-[336px] h-[72px]">
          <div className="text-[14px] font-bold text-[#49454f]">예상 용의 목록</div>
          <input
            type="text"
            value={distractions}
        ...
        <button
          ...
          className={`relative w-[336px] h-[52px] rounded-[5px] text-[#fff] font-bold text-[18px] ${
