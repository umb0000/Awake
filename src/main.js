...
const Main = () => {
  ...
  return (
    <div className="relative w-[100%] h-[800px] custom-gradient overflow-hidden">
     ...
     {/* 말풍선 */}
      <div className="absolute top-12 left-6 bg-white text-white px-4 py-2 rounded-lg shadow-lg max-w-[80px] h-[50px] flex items-center justify-center text-center break-normal whitespace-normal z-10">
