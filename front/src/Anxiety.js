...
const Anxiety = () => {
  ...
  <div className="absolute left-0 top-[30px] w-[360px] h-[680px] flex flex-col items-center justify-start gap-[10px] py-[9px] px-[10px]">
    <div className="relative w-[328px] h-[51px] shrink-0 flex flex-col items-start justify-start py-[7px] px-0">
      <div className="absolute left-0 top-[5px] w-[308px] h-[41px] shrink-0 flex flex-row items-center justify-start gap-[11px] overflow-hidden">
        <img width="24" height="22" src="Vector1_233.png"></img>
    ...
    <div className="w-[360px] flex flex-col items-center justify-start gap-[8px] bg-[#fff]">
      <div className="self-stretch h-[63px] shrink-0 flex flex-row items-center justify-center bg-[#f5f5f5]">
        <div className="relative w-[337px] h-[73px] shrink-0 flex">
          ...
          <img className="absolute left-[292px] top-[15px]" width="26" height="43" src="./img/3dicons1_250.png"></img>
        </div>
      </div>
      <div className="self-stretch h-[1px] shrink-0 bg-[#fff]"></div>
      <div className="w-[328px] h-[166px] shrink-0 flex flex-row items-center justify-center gap-[11px]">
        <div className="relative w-[160px] h-[166px] shrink-0 flex">
          ...
          <img className="absolute left-[81px] top-[12px]" width="66" height="78" src="3dicons1_257.png"></img>
          <img className="absolute left-[77.19%] right-[8.44%] top-[74.1%] bottom-[12.65%]" width="23" height="22" src="별1_258.png"></img>
        </div>
        <div className="relative w-[160px] h-[166px] shrink-0 flex">
          ...
          <img className="absolute left-[81px] top-[12px]" width="69" height="81" src="src/img/3dicons1_263.png"></img>
          <img className="absolute left-[79.06%] right-[6.56%] top-[75.3%] bottom-[11.45%]" width="23" height="22" src="별1_264.png"></img>
        </div>
      </div>
      <div className="w-[328px] h-[68px] shrink-0 flex flex-col items-start justify-center py-[10px] px-[20px] bg-[#f8f8f8] rounded-[16px]">
        <div className="self-stretch text-[16px] leading-[24px] tracking-[.01em] font-['Pretendard_Variable'] font-bold text-[#000]">나의 불안일지</div>
        <div className="self-stretch text-[10px] leading-[10px] tracking-[.01em] font-['Pretendard_Variable'] font-semibold text-[#000]">불안의 책 스크랩 모음</div>
      </div>
  ...
  <div className="absolute left-0 top-0 w-[360px] h-[45px] flex flex-row items-end justify-between py-[10px] px-[24px]">
    ...
    <img width="46" height="17" src="right iconsI1_276;50758_11372.png"></img>
  </div>
  <div className="absolute left-0 top-[720px] h-[80px] flex flex-row items-start justify-start gap-[8px] py-0 px-[8px] bg-[#fff] border-[0px] border-solid border-[#d9d9d9] shadow-[0_1px_3px_1px_#00000026]">
    <img width="80" height="80" src="Nav item 59_122.png"></img>
    <img width="80" height="80" src="Nav item 69_127.png"></img>
    <img width="80" height="80" src="Nav item 41_288.png"></img>
    <img width="80" height="80" src="Nav item 79_132.png"></img>
  </div>
</div>
  );
};
