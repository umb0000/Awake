  ...
  return (
    <div className="relative w-[100%] h-screen custom-gradient overflow-hidden">
      ...
      <div className="relative left-0 top-0 w-[100%] flex flex-col items-center justify-start gap-[5px]">
        ...
        {/* 오른쪽 상단 메일 아이콘 버튼 */}
        <button
        className="absolute top-20 right-4 w-[49px] h-[50px] flex items-center justify-center z-10"
        ...
        <div className="relative flex-col items-start">
            <div>
              <span className="w-full h-[40px] text-[24px] leading-[24px] tracking-[.01em] font-bold font-[Pretendard] text-[#000] items-start justify-center">{((completedCards / totalCards) * 100).toFixed(1)}% </span>
