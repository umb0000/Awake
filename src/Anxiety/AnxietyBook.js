...
const AnxietyBook = () => {
  return (
    <div className="relative w-full h-sreen bg-[#fff] px-4 py-6"> {/* 좌우 여백과 상단 여백 조정 */}
      <div className="w-full h-[800px] flex flex-col items-center justify-start gap-[15px]">
        ...
        <div className="w-full max-w-md flex flex-row items-center justify-center p-4 bg-[#eeefef] rounded-[15px]">
          <div className="text-[14px] font-['Roboto'] font-medium text-[#000] whitespace-nowrap">다음</div>
        </div>
      </div>
    </div>
  );
