...
const ConflictResolution = () => {
  return (
    <div className="relative w-[100%] h-[800px] bg-[#fff] overflow-hidden">
      {/* 상단바 */}
      <div className="absolute left-0 top-0 w-[100%] h-[45px] flex items-center justify-between px-[15px] py-[10px]">
        <div className="text-[20px] font-bold">상감이결 공식</div>
      </div>

      {/* 내용 */}
      <div className="absolute top-[45px] w-[100%] flex flex-col items-center gap-[12px] px-[15px]">
        {/* 단계 1: 상황 설명 */}
        <div className="w-[327px] h-[165px] flex items-center gap-[10px] p-[10px] bg-[#fff] border border-solid border-[#d9d9d9] rounded-[15px]">
          ...
          <div className="flex-1 flex flex-col gap-[8px]">
            ...
            <div className="text-[9px] text-gray-400">예시: 지금 프로젝트 마감일이 다가오고 있어요.</div>
          </div>
        </div>
        ...
        <div className="w-[327px] h-[165px] flex items-center gap-[10px] p-[10px] bg-[#fff] border border-solid border-[#d9d9d9] rounded-[15px]">
          ...
          <div className="flex-1 flex flex-col gap-[8px]">
            ...
            <div className="text-[9px] text-gray-400">예시: 이 상황 때문에 저는 조금 불안하고 초조해요.</div>
          </div>
        </div>
        ...
        <div className="w-[327px] h-[165px] flex items-center gap-[10px] p-[10px] bg-[#fff] border border-solid border-[#d9d9d9] rounded-[15px]">
          ...
          <div className="flex-1 flex flex-col gap-[8px]">
            ...
            <div className="text-[9px] text-gray-400">예시: 제가 이렇게 느끼는 이유는 마감 기한을 지키지 못하면 프로젝트가 차질을 빚을까 걱정되기 때문이에요.</div>
          </div>
        </div>
        ...
        <div className="w-[327px] h-[165px] flex items-center gap-[10px] p-[10px] bg-[#fff] border border-solid border-[#d9d9d9] rounded-[15px]">
          ...
          <div className="flex-1 flex flex-col gap-[8px]">
            ...
            <div className="text-[9px] text-gray-400">예시: 우리 모두 마감 기한 전에 각자의 역할을 다시 점검하면 좋을 것 같아요.</div>
          </div>
        </div>
      </div>
    </div>
