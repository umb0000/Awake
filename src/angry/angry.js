  ...
  return (
    <div className="relative w-[100%] h-auto bg-[#fff] overflow-hidden font-['Pretendard_Variable']">
      <div className="w-[100%] flex flex-col items-center justify-start gap-[8px] bg-[#fff]">
        ...
        {/* Scrollable section */}
        <div
          className="w-[95%] h-[166px] shrink-0 flex flex-row items-center justify-center gap-[10px]"
          ref={containerRef}
        ...
        >
          <div className="relative w-[168px] h-[166px] flex-shrink-0 flex">
          ...
          <div className="relative w-[168px] h-[166px] flex-shrink-0 flex">
            ...
            >
              ...
              <img
                className="absolute left-[88px] top-[22px]"
                width="67"
                height="78"
                src={process.env.PUBLIC_URL + "/img/3dicons1_535.png"}
                alt="3d icon"
              />
            </a>
          </div>
